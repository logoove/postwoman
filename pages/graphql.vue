  ...
  <div class="page">
    <div class="content">
      <div class="page-columns inner-left">
        <pw-section class="blue" label="端点" ref="endpoint">
          <ul>
            <li>
        ...
        <pw-section class="orange" label="Headers" ref="headers">
          <ul>
            <li>
              <div class="flex-wrap">
                <label for="headerList">头部列表</label>
                <div>
                  <button
                    class="icon"
                    @click="headers = []"
        ...
        <pw-section class="green" label="模式" ref="schema">
          <div class="flex-wrap">
            <label>请求</label>
            <div>
              <button
        ...
        <pw-section class="cyan" label="查询" ref="query">
          <div class="flex-wrap">
            <label for="gqlQuery">查询</label>
            <div>
              <button
                class="icon"
                @click="runQuery()"
                v-tooltip.bottom="'运行查询'"
              >
        ...
        <pw-section class="purple" label="请求" ref="response">
          <div class="flex-wrap">
            <label for="responseField">请求</label>
            <div>
              <button
                class="icon"
                @click="copyResponse"
      ...
      <aside class="sticky-inner inner-right">
        <pw-section class="purple" label="文档" ref="docs">
          <section>
            <input
            ...
            <input
              ...
              checked="checked"
            />
            <label v-if="gqlTypes.length > 0" for="gqltypes-tab">类型</label>
  ...
  methods: {
    ...
    async getSchema() {
      ...
      try {
        ...
        this.$nuxt.$loading.finish();
        this.schemaString = error + ". 检查控制器详情.";
        this.$toast.error(error + " (F12查看详情)", {
          icon: "error"
        });
        console.log("Error", error);
