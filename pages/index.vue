    ...
    <div class="content">
      <div class="page-columns inner-left">
        ...
        <pw-section class="blue" label="请求" ref="request">
          <ul>
            ...
            <ul>
              <li>
                ...
                >
                  {{ $t("发送") }}
                  <span id="hidden-message">重复</span>
                  <span>
          ...
          >
            ...
            <div v-else>
              <ul>
                <li>
                  <label for="rawBody">Raw请求body</label>
                  <textarea
                    id="rawBody"
                    @keydown="formatRawParams"
                    rows="8"
        ...
        <section id="options">
          ...
          <label for="tab-two">请求头</label>
          <div class="tab">
            <pw-section class="orange" label="请求头" ref="headers">
              <ul>
                <li>
                  <div class="flex-wrap">
                    <label for="headerList">列表</label>
                    <div>
                      <button
                        class="icon"
          ...
          <label for="tab-three">参数</label>
          <div class="tab">
            <pw-section class="pink" label="参数" ref="parameters">
              <ul>
                <li>
                  <div class="flex-wrap">
                    <label for="paramList">参数列表</label>
                    <div>
                      <button
                        class="icon"
      ...
      <aside class="sticky-inner inner-right">
        <section>
          ...
          <label for="history-tab">历史记录</label>
          <div class="tab">
            <history
          ...
          <label for="collection-tab">集合</label>
          <div class="tab">
            <pw-section class="yellow" label="集合" ref="collections">
              <collections />
            </pw-section>
          </div>
        </section>
      ...
      <pw-modal v-if="!isHidden" @close="isHidden = true">
        ...
        <div slot="body">
          ...
          <ul>
            <li>
              <div class="flex-wrap">
                <label for="generatedCode">生成代码</label>
                <div>
                  <button
                    class="icon"
  ...
  methods: {
    ...
    async sendRequest() {
      ...
      try {
        ...
        this.$toast.info(`完成时间 ${duration}ms`, {
          icon: "done"
        });
        ...
        if (error.response) {
          ...
          this.response.body = error + ". 检查控制台详情.";
          this.$toast.error(error + " (F12查看详情)", {
            icon: "error"
          });
          if (!this.$store.state.postwoman.settings.PROXY_ENABLED) {
            this.$toast.info("尝试启用代理", {
              icon: "help",
              duration: 8000,
              action: {
                text: "Settings",
    ...
    copyRequest() {
      if (navigator.share) {
        ...
        navigator
          .share({
            title: `Postwoman`,
            text: `Postwoman • API请求构建在 ${time} on ${date}`,
    ...
    uploadPayload() {
      ...
      if (file !== null) {
        ...
        this.$toast.info("文件导入", {
          icon: "attach_file"
        });
      } else {
        this.$toast.error("选择一个文件", {
          icon: "attach_file"
        });
      }
    }
