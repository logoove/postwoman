<template>
  <modal v-if="show" @close="hideModal">
    ...
    <div slot="body">
      <ul>
        <li>
          <label for="selectLabel">标签</label>
          <input
            type="text"
            id="selectLabel"
          ...
          <label for="selectCollection">集合</label>
          <select
            type="text"
            id="selectCollection"
          ...
          <label for="selectFolder">目录</label>
          <select
            type="text"
            id="selectFolder"
          ...
          <label for="selectRequest">请求</label>
          <select
            type="text"
            id="selectRequest"
