<template>
  <pw-section class="green" icon="history" label="历史记录" ref="history">
    <ul>
      ...
      <ul v-for="(entry, index) in filteredHistory" :key="index" class="entry">
        <div class="show-on-large-screen">
          <button
            ...
            v-tooltip="{ content: !entry.star ? '加星' : '删除加星' }"
          >
...
-->
    ...
    <div v-if="history.length !== 0">
      <div class="flex-wrap" v-if="!isClearingHistory">
        ...
        <v-popover>
          <button class="tooltip-target icon" v-tooltip="'排序'">
      ...
      <div class="flex-wrap" v-else>
        <label for="clear-history-button">你确定吗?</label>
        <div>
          <button
            class="icon"
